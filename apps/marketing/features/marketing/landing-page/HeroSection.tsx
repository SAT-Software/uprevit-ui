  ...
  return (
    <div className="max-w-2xl mx-auto flex flex-col items-center justify-center min-h-[650px] md:min-h-[800px] h-[400px] md:h-[800px]">
      ...
      <div className="flex flex-col items-center gap-4">
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-center tracking-tighter">
        ...
        <div className="flex flex-col gap-1 items-center mt-4">
          <p className="text-base md:text-lg lg:text-xl font-normal text-black dark:text-white text-center tracking-tight leading-tight">
            The unified cloud-based platform for total labeling governance
          </p>

          <p className="w-[80%] text-xs md:text-sm lg:text-base text-center text-muted-foreground dark:text-muted-foreground/60">
