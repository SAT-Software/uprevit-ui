...
<Cards>
  ...
  <Card
    ...
    href="/docs/product-documentation/product-overview"
    description="Overview of all seven tabs; complete each one before submit."
    icon={<DocsIcon icon={LayoutGridIcon} />}
  />
  <Card
