...
export default function AddOtherCompsDialog({
  ...
  const id = useId();
  const formId = `add-other-comps-form-${id}`;
  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      <AppDialogContent
        title="Add New Other Component"
        description="Add a new other components item by providing details and uploading an image."
        variant="form"
        size="lg"
        primaryAction={{
          label: "Add Component",
