...
export default function EditOtherComponentsDialog({
  ...
  const id = useId();
  const formId = `edit-other-comps-form-${id}`;
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <AppDialogContent
        title="Edit Other Component"
        description="Edit other components item by updating details and uploading a new image."
        variant="form"
        size="lg"
        primaryAction={{
      ...
      >
        <form id={formId} onSubmit={handleSubmit(onSubmit)} noValidate>
          <FieldGroup className="gap-4 p-4">
            <Field>
              <GraphicsImageUpload
                key={`${otherComponent.id}-${open ? "open" : "closed"}`}
                imageUrl={otherComponent.componentImage}
                label="Component Image"
                tooltip="Upload a reference image for this component."
            ...
            <Field data-invalid={!!errors.componentName}>
              <FormFieldLabel
                ...
                tooltip="The display name for this other component."
              />
            ...
            <Field>
              <FormFieldLabel
                ...
                label="Description"
                tooltip="Describe the component's purpose, content, and specifications."
                optional
              />
              <InputGroup size="md" className="bg-background">
                <InputGroupTextarea
            ...
            <Field>
              <FormFieldLabel
                ...
                tooltip="Label types where this component appears. Press Enter after each entry."
                optional
              />
              <TagInput
