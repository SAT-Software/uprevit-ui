      ...
      <div className="relative w-full">
        <div className="max-w-6xl mx-auto relative">
          ...
          <div className="p-1 bg-accent rounded-2xl max-w-6xl mx-auto border border-border">
            <div className="w-full bg-foreground dark:bg-background rounded-[14px] h-120 text-background dark:text-foreground p-10 gap-20 flex items-center justify-between overflow-hidden">
              ...
              <div className="w-full flex justify-center md:justify-end">
                <div className="relative w-[560px] sm:w-[640px] md:w-[720px] lg:w-[900px] -mr-10">
                  ...
                  <div
                    className="relative overflow-hidden rounded-2xl top-25 border border-neutral-800/50 bg-background/5 shadow-[0_30px_80px_-20px_rgba(0,0,0,0.6)]"
                    style={{
                      transform:
